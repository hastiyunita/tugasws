        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#modal1${team.id}" class="secondary-content waves-effect waves-light btn modal-trigger"><i class="material-icons">info</i></a>
                </li>
                <div id="modal1${team.id}" class="modal">
            ...
            const modaldetil = document.querySelectorAll('.secondary-content')
            M.Modal.init(modaldetil);
        }).catch(err => {
            console.error(err);
        })
}
...
function showTeamInfo(id){
    ...
    contents.innerHTML="Berikut merupakan informasi detail dari tim dengan id " + url
}
